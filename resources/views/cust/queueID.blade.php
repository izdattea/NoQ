                ...
                {{-- <div class="max-w-xs sm:px-6 lg:px-8"> --}}
                    <div class="bg-white overflow-hidden shadow-lg rounded-lg m-4"> 
                        <div class="p-8 sm:px-20 bg-white border-b border-gray-200">
                            ...
                            <div class="text-black text-[32px] text-center font-bold">
                            ...
                            <div class="text-black text-lg text-center font-bold pb-4">
                                {{ 1000+$cust->id }} <!-- $rest->queue?? -->
                            </div>
                            <div class="text-black text-[14px] text-center font-bold pb-4">
                                Estimated Time To Be  Called: <br/> 
                                @if ($cust->est_enter == NULL)
                                    {{ $cust->in_queue }}
                                @else 
                                    {{ $cust->est_enter }}  
                                @endif
